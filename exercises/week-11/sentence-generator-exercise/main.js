...
let noun = nouns[Math.floor(Math.random() * nouns.length)] // 0, 1, 2
let verb = verbs[Math.floor(Math.random() * verbs.length)] // 0, 1, 2
let adjective = adjectives[Math.floor(Math.random() * adjectives.length)] // 0, 1, 2
